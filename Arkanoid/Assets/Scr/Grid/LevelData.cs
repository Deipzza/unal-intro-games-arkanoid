...
public class LevelData : ScriptableObject {
    [Range(1, 10)] public int RowCount = 7;
    public float rowSpacing = 0.1f;
    public List<GridRowData> Rows = new List<GridRowData>();
}

[System.Serializable] // Para poder visualizar la clase en el inspector
public class GridRowData { //COntendrá la información de los bloques de una fila
    [Range(1, 24)]
